...
## Калькулятор
    ...
    Тип поверхности (Поле : Radio одиночный выбор) //Укажите тип поверхности
        /=Х% - Коэффициент увеличения утепляемой площади при покрытии на неровную поверхность или на поверхность имеющую волну
        -Волна 10мм /=10%
        -Волна 30мм /=20%
        -Волна 40мм /=30%
        -Волна 50мм /=40%
    ...
    Укажите площадь под которую необходимо установить леса (при высоте объекта более 3 метров)
